...
RSpec.describe RotationsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    subject(:page) { get :show, params: {id: rotation.id} }
  ...
  describe "PUT #update" do
    ...
    subject(:page) { put :update, params: {id: rotation.id, rotation: attributes_for(:rotation)} }
  ...
  describe "DELETE #destroy" do
    ...
    subject(:page) { delete :destroy, params: {id: rotation.id} }
  ...
  describe "GET #list" do
    ...
    let(:rotation) { create(:rotation, {:machine_id => machine.id}) }
