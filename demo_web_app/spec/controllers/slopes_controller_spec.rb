...
RSpec.describe SlopesController, type: :controller do
  ...
  describe "GET #show" do
    ...
    subject(:page) { get :show, params: {id: slope.id} }
  ...
  describe "PUT #update" do
    ...
    subject(:page) { put :update, params: {id: slope.id, slope: attributes_for(:slope)} }
  ...
  describe "DELETE #destroy" do
    ...
    subject(:page) { delete :destroy, params: {id: slope.id} }
  ...
  describe "GET #list" do
    ...
    let!(:slopes) { [ slope ] }
    let(:slope) { create(:slope, {:machine_id => machine.id}) }
